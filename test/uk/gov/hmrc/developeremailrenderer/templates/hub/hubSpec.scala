...
package uk.gov.hmrc.developeremailrenderer.templates.hub

import junit.framework.TestCase
import org.scalatest.matchers.should.Matchers
import org.scalatest.wordspec.AnyWordSpec

import uk.gov.hmrc.developeremailrenderer.templates.hub

class hubSpec extends AnyWordSpec with Matchers {
  ...
  "textView" should {
    "render as" in new TestCase {
      val renderedTxt = hub.txt.hub.render(templateParams)
  ...
  "textView for showFooter and showHmrcBanner" should {
    "render as " in new TestCase {
      val renderedTxt = hub.txt.hub.render(templateParams2)
      renderedTxt.contentType should include("text/plain")
      renderedTxt.body should include("This is the body")
    }
  }
